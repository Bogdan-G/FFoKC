...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, net.minecraft.entity.Entity entity) {
        ...
        else if (entity.getClass().equals(net.minecraft.entity.Entity.class.getClass()) || entity instanceof net.minecraft.entity.Entity) { return new CraftCustomEntity(server, (net.minecraft.entity.Entity) entity); }
